...
{
  echo minify_get_javascripts($response = sfContext::getInstance()->getResponse(), sfConfig::get('sf_compressed'));
}
...
{
  echo minify_get_stylesheets($response = sfContext::getInstance()->getResponse(), sfConfig::get('sf_compressed'));
}
